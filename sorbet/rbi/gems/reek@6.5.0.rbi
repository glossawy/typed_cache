...
class Reek::AST::Node < ::Parser::AST::Node
  ...
  #
  # source://reek//lib/reek/ast/node.rb#112
  def condition; end
  ...
  #
  # source://reek//lib/reek/ast/node.rb#67
  def each_node(target_types, ignoring = T.unsafe(nil), &blk); end

  # source://reek//lib/reek/ast/node.rb#80
  def format_to_ruby; end

  # source://reek//lib/reek/ast/node.rb#22
  def full_comment; end

  # source://reek//lib/reek/ast/node.rb#26
  def leading_comment; end

  # Provide length for statement counting. A sexp counts as one statement.
  #
  # source://reek//lib/reek/ast/node.rb#94
  def length; end

  # source://reek//lib/reek/ast/node.rb#34
  def line; end

  # source://reek//lib/reek/ast/node.rb#38
  def name; end

  # source://reek//lib/reek/ast/node.rb#107
  def source; end
  ...
  #
  # source://reek//lib/reek/ast/node.rb#103
  def statements; end
  ...
  #
  # source://reek//lib/reek/ast/node.rb#117
  def look_for(lookup_rule, &blk); end
  ...
  #
  # source://reek//lib/reek/ast/node.rb#128
  def look_for_recurse(lookup_rule, &blk); end

  private

  # Returns the value of attribute comments.
  #
  # source://reek//lib/reek/ast/node.rb#139
  def comments; end

  # source://reek//lib/reek/ast/node.rb#141
  def each_sexp; end
end

# Struct representing the rules for the search performed by each_node method.
#
# source://reek//lib/reek/ast/node.rb#13
class Reek::AST::Node::NodeLookupRule < ::Struct
  # Returns the value of attribute ignoring
  #
  # @return [Object] the current value of ignoring
  def ignoring; end

  # Sets the attribute ignoring
  #
  # @param value [Object] the value to set the attribute ignoring to.
  # @return [Object] the newly set value
  def ignoring=(_); end

  # Returns the value of attribute target_types
  #
  # @return [Object] the current value of target_types
  def target_types; end

  # Sets the attribute target_types
  #
  # @param value [Object] the value to set the attribute target_types to.
  # @return [Object] the newly set value
  def target_types=(_); end
...
class Reek::Context::CodeContext
  ...
  def local_nodes(type, ignored = T.unsafe(nil), &_arg2); end
...
module Reek::Report
  class << self
    ...
    #
    # source://reek//lib/reek/report.rb#75
    ...
    #
    # source://reek//lib/reek/report.rb#65
    ...
    #
    # source://reek//lib/reek/report.rb#85
    ...
    #
    # source://reek//lib/reek/report.rb#55
    ...
    #
    # source://reek//lib/reek/report.rb#95
...
#
# source://reek//lib/reek/report/github_report.rb#12
class Reek::Report::GithubReport < ::Reek::Report::BaseReport
  # source://reek//lib/reek/report/github_report.rb#13
  def show(out = T.unsafe(nil)); end

  private

  # source://reek//lib/reek/report/github_report.rb#19
  def workflow_commands; end
end

# Represents a smell as a GitHub Workflow command.
#
# source://reek//lib/reek/report/github_report.rb#26
class Reek::Report::GithubReport::WorkflowCommand
  # @return [WorkflowCommand] a new instance of WorkflowCommand
  #
  # source://reek//lib/reek/report/github_report.rb#27
  def initialize(smell); end

  # source://reek//lib/reek/report/github_report.rb#31
  def to_s; end

  private

  # source://reek//lib/reek/report/github_report.rb#41
  def file; end

  # source://reek//lib/reek/report/github_report.rb#45
  def line; end

  # source://reek//lib/reek/report/github_report.rb#49
  def message; end
end

# source://reek//lib/reek/report.rb#34
...
# source://reek//lib/reek/report.rb#28
Reek::Report::LOCATION_FORMATTERS = T.let(T.unsafe(nil), Hash)

# source://reek//lib/reek/report.rb#39
...
# source://reek//lib/reek/report.rb#19
...
# source://reek//lib/reek/report.rb#44
...
class Reek::Source::SourceCode
  ...
  #
  # source://reek//lib/reek/source/source_code.rb#120
  def parse; end

  # Returns the value of attribute parser.
  #
  # source://reek//lib/reek/source/source_code.rb#91
  def parser; end
