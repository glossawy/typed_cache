...
class Dry::Events::Bus
  ...
  # @return [Boolean]
  #
  # source://dry-events//lib/dry/events/bus.rb#92
  ...
  # @api private
  #
  # source://dry-events//lib/dry/events/bus.rb#74
  def subscribe(event_id, filter, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-events//lib/dry/events/bus.rb#80
...
module Dry::Events::Publisher::InstanceMethods
  ...
  def process(event_id, payload = T.unsafe(nil), &_arg2); end
